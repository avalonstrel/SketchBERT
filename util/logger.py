...
class TensorBoardLogger(object):
    ...
    def scalar_summary(self, tag, value, step):
        ...
        summary = tf.compat.v1.summary.Summary(value=[tf.compat.v1.summary.Summary.Value(tag=tag, simple_value=value)])
    ...
    def image_summary(self, tag, images, step):
        ...
        summary = tf.compat.v1.summary.Summary(value=img_summaries)
        self.writer.add_summary(summary, step)
