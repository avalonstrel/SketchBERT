...
def get_inceptionv4_model(type='inceptionv4', num_classes=365, pretrained='imagenet', restore_path='/home/lhy/Project/Sketch/SketchGeneration/Sentence2Sketch/model_logs/201903012348_pretrain_sketches_cls_inceptionv4/latest_ckpt.pth.tar'):
    ...
    if restore_path is not None:
        if not os.path.exists(restore_path):
            print("Restore Path {} Not Exist".format(restore_path))
        checkpoint = torch.load(restore_path)
        model_dict = model.state_dict()
        pretrained_dict = checkpoint['net_best_state']
